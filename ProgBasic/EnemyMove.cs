...
using System.ComponentModel; // Ez nem tudom mikor és hogyan került ide. Egyszer csak itt lett :S
...
if (dx == 0 && dy == 0) { Console.WriteLine("Baszdki mán késő! Elkapott a ganyé!"); } // Ha ugyanott van a játékos és az ellenfél
...
else 
{
    ...
    else
    {
        ...
        // Feltételezzük, hogy a játékos egy helyben áll, az ellenfél sebességvektora pedig a játékos irányába mutat és egyenletes mozgást végez.
